...
CREATE TABLE IF NOT EXISTS `banners` (
  ...
  `banner_alt` varchar(100) NOT NULL DEFAULT '',
  `banner_size` varchar(20) NOT NULL DEFAULT '',
...
`id` int(11) NOT NULL,
  ...
  `minium_membership` int(11) NOT NULL DEFAULT '0',
...
`emailtempl_id` int(11) NOT NULL DEFAULT '0',
  `code` varchar(120) NOT NULL DEFAULT '',
  `description` varchar(250) NOT NULL DEFAULT '',
  `subject` varchar(250) NOT NULL DEFAULT '',
  `message` text NOT NULL DEFAULT '',
  `tag_descr` text NOT NULL DEFAULT ''
...
CREATE TABLE IF NOT EXISTS `textads` (
  ...
  `textad_heading` varchar(50) NOT NULL DEFAULT '',
  `textad_line1` varchar(50) NOT NULL DEFAULT '',
  `textad_line2` varchar(50) NOT NULL DEFAULT '',
  `textad_domain` varchar(50) NOT NULL DEFAULT '',
...
`member_id` int(11) NOT NULL DEFAULT '0',
  ...
  `membership` varchar(50) NOT NULL DEFAULT '',
  `membership_expiration` int(11) NOT NULL DEFAULT '0',
  `matrix_level` int(5) NOT NULL  DEFAULT '0',
  `processor` int(1) NOT NULL DEFAULT '0',
  ...
  `display_name` int(11) NOT NULL DEFAULT '0',
  `display_email` int(11) NOT NULL DEFAULT '0',
  `log_ip` int(11) NOT NULL  DEFAULT '1',
  `m_level` int(11) NOT NULL  DEFAULT '0',
  `ad_credits` decimal(12,3) NOT NULL DEFAULT '0.000',
  `forgot_token` varchar(128) NOT NULL DEFAULT '',
  `activation_token` varchar(128) NOT NULL DEFAULT ''
) ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
`money_out_id` int(11) NOT NULL DEFAULT '0',
  `transfer_date` int(11) NOT NULL  DEFAULT '0',
  `amount` decimal(12,2) NOT NULL DEFAULT '0.00',
  `member_id` int(11) NOT NULL  DEFAULT '0',
  `processor` int(5) NOT NULL DEFAULT '0',
...
`optin_id` int(11) NOT NULL DEFAULT '0',
  `optin_title` varchar(100) NOT NULL DEFAULT '',
  `optin_body` text NOT NULL DEFAULT ''
) ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
`processor_id` int(11) NOT NULL DEFAULT '0',
  ...
  `sandbox_url` varchar(100) NOT NULL DEFAULT ''
