...
//                    } 
        ...
        */
		...
		$template_dir = $compiler->smarty->template_dir;
		$include_temp = str_replace(array("'", '"'), '', $include_file);
		//echo $template_dir . pathinfo($include_temp)['dirname'] . '/'. pathinfo($include_temp)['filename'] . '_custom.' . pathinfo($include_temp)['extension']; exit;
		if(file_exists($template_dir . pathinfo($include_temp)['dirname'] . '/'. pathinfo($include_temp)['filename'] . '_custom.' . pathinfo($include_temp)['extension'])) {			
			$include_file = "'". pathinfo($include_temp)['dirname'] . '/'. pathinfo($include_temp)['filename'] . '_custom.' . pathinfo($include_temp)['extension']."'";
		}
        $_output = "<?php ";
