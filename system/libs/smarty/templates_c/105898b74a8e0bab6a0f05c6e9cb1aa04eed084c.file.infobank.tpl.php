<?php /* Smarty version Smarty-3.0.8, created on 2019-06-03 09:59:51
         compiled from "system/app/views/members/infobank.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14298581885cf5520750b030-83696653%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '105898b74a8e0bab6a0f05c6e9cb1aa04eed084c' => 
    array (
      0 => 'system/app/views/members/infobank.tpl',
      1 => 1519037900,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14298581885cf5520750b030-83696653',
  'function' => 
  array (
  ),
...
<?php  $_smarty_tpl->assign('comm', ob_get_contents()); Smarty::$_smarty_vars['capture']['default']=ob_get_clean();?> 
                                       <?php $_smarty_tpl->tpl_vars['file'] = new Smarty_variable($_smarty_tpl->tpl_vars['name']->value['download'], null, null);?>    

                                       <?php if (in_array($_smarty_tpl->tpl_vars['name']->value['productCode'],$_smarty_tpl->getVariable('orders')->value)){?><a target="_blank" href="https://plusmoreusaeng.com/system/app/plugins/cart/assets/<?php echo $_smarty_tpl->getVariable('file')->value;?>
"onClick="return confirm ('<?php echo $_smarty_tpl->getVariable('lang')->value['you_need_to_upgrade_your_membership_to_download_this_file'];?>
');"><strong><?php echo $_smarty_tpl->tpl_vars['name']->value['name'];?>
</strong></a><?php }else{ ?><?php if ($_smarty_tpl->tpl_vars['name']->value['price']==0.00){?><a  target="_blank" href="https://plusmoreusaeng.com/system/app/plugins/cart/assets/<?php echo $_smarty_tpl->getVariable('file')->value;?>
"onClick="return confirm ('<?php echo $_smarty_tpl->getVariable('lang')->value['you_need_to_upgrade_your_membership_to_download_this_file'];?>
');"><strong><?php echo $_smarty_tpl->tpl_vars['name']->value['name'];?>
</strong></a><?php }else{ ?><strong><?php echo $_smarty_tpl->tpl_vars['name']->value['name'];?>
</strong><?php }?><?php }?><?php if ($_smarty_tpl->tpl_vars['name']->value['featured']=="yes"){?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="/assets/members/images/featured.png" /><?php }?>                                  
                                    </td>
                                    <td><?php echo $_smarty_tpl->tpl_vars['name']->value['description'];?>
</td>                                    
                                    <td><?php echo $_smarty_tpl->tpl_vars['name']->value['price'];?>
 $</td>                                    
                                    <td>PlusMoreUsa</td>
                                    <td><?php if ($_smarty_tpl->tpl_vars['name']->value['price']==0.00){?><?php }else{ ?><?php if (in_array($_smarty_tpl->tpl_vars['name']->value['productCode'],$_smarty_tpl->getVariable('orders')->value)){?><?php }else{ ?> <a prid="<?php echo $_smarty_tpl->tpl_vars['name']->value['id'];?>
" href="#" class="btn btn-success addproduct" style="margin:0px !important;"><i class="icon-shopping-cart"></i>add to cart </a><?php }?><?php }?>
                                    </td>
                                 </tr>
                                 <?php }} ?>
                               <?php }?>                              
