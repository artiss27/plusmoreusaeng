<?php /* Smarty version Smarty-3.0.8, created on 2019-06-07 10:33:24
         compiled from "system/app/views/admin/login.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15700781205cfa9fe42b9676-63697837%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '547fab73ce085813b13a08b2aeea0b4840cc355f' => 
    array (
      0 => 'system/app/views/admin/login.tpl',
      1 => 1510261266,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15700781205cfa9fe42b9676-63697837',
  'function' => 
  array (
  ),
...
?>
              ...
              <font size="2" color="#6a6c6f">Area Privada</font></center><br>
                                ...
                                <input type="text" title="Please enter you username" required value="<?php if (@DEMO==1){?>admin<?php }?>" name="user" id="user" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" title="Please enter your password" required value="<?php if (@DEMO==1){?>admin<?php }?>" name="password" id="password" class="form-control">
                                <span class="help-block small">Tu contrase&ntildea dificil</span>
                            </div>                            
                            <button class="btn btn-success btn-block">Acceder</button>
                        </form>
						<?php if (@DEMO==1){?>Demo is reseted every 20 minutes<?php }?>
                </div>
            </div>
        </div>
    </div>
