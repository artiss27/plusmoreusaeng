...
class Smarty extends Smarty_Internal_Data {
	...
	*/
    ...
    {		
		if(file_exists($this->template_dir . pathinfo($template)['dirname'] . '/'. pathinfo($template)['filename'] . '_custom.' . pathinfo($template)['extension'])) {
			$template = $this->template_dir . pathinfo($template)['dirname'] . '/'. pathinfo($template)['filename'] . '_custom.' . pathinfo($template)['extension'];
		}
        // display template
