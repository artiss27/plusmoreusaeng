...
class AuthnetAIM
{
    ...
    final public function setTransaction($first_name, $last_name, $cardnum, $expiration, $amount, $cvv = null, $invoice = null, $tax = null)
    {
        $this->params['x_card_num']    = (string) trim($cardnum);
        $this->params['x_exp_date']    = (string) trim($expiration);
		
		$this->params['x_first_name']  = (string) trim($first_name);
		$this->params['x_last_name']   = (string) trim($last_name);
