                                     ...
                                     <input type="hidden" name="type" value="new" />
										<div class="form-body">
											<div class="note tile-title">
												<h4>{$plugin_lang.edit_campaign_id}: {$banner.id}</h4>
                                                <br />
											...
											<div class="form-group">
												<label>{$plugin_lang.campaign_title}</label>
                                                 <div class="input">																								
													 <input type="text" class="form-control" placeholder="{$plugin_lang.campaign_title}" name="campaign_title" value="{$banner.campaign_title}">	
                                                 </div>   											
											</div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input">																				
													 <input type="text" class="form-control" placeholder="{$plugin_lang.amount}" name="ad_credit_bid" value="{$banner.ad_credit_bid}">												
                                                 </div>    
											</div>
                                            ...
                                            <div class="form-group">
												<label>{$plugin_lang.target_url}</label>	
                                                 <div class="input">																								
													 <input type="text" class="form-control" placeholder="{$plugin_lang.url}" name="target_url" value="{$banner.target_url}">												
                                                 </div>
											</div>		 
                                              
                                            <div class="form-group">
												<label><img src="{$banner.banner_url}" /></label>	
