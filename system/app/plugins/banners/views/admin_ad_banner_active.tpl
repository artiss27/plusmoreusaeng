...
<div class="normalheader transition animated fadeIn">
   <div class="hpanel">
      <div class="panel-body">
         ...
         <small>Approved member submitted banner campaigns</small>
      </div>
   </div>
</div>
<div class="row">
                              ...
                              <table id="banner_active" class="table table-striped table-bordered table-hover">
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td><a href="/plugins/banners/badmin/pendingaction/&disapprove={$banner.id}" onclick="return confirm('Are you sure you want to disapprove this banner campaign');">disapprove</a>
                                       </td>
                                    </tr>
                                    {/foreach}   	
                                    {/if}							
