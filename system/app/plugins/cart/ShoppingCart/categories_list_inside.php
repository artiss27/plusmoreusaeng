...
foreach ($rows as $rs) {
    ...
    echo "<a href='/store/category/" . $rs['id'] . "/' class='btn btn-default' style='margin-bottom:20px; margin-right:20px;'>" . $rs['name'] . "</a>";
}

//
// View shopping cart only for smartphone
//
echo '<div class="visible-xs visible-sm" style="padding-bottom: 30px;"><a href="/store/view/" class="btn btn-success" >View shoppingcart</a></div>';
?>
