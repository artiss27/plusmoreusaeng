...
$(function () {
    ...
    $(".addproduct-sheet").click(function( e ) {
        ...
        $("#BSCart").load("ShoppingCart/addproduct_vertical_inside.php?id="+id+"&type="+type+"&size="+size+"&quantity="+quantity);   
        console.log ("added id:"+id+" Qty:"+quantity); // console debug
        console.log ("ShoppingCart/addproduct_vertical_inside.php?id="+id+"&type="+type+"&size="+size+"&quantity="+quantity); 
        e.preventDefault();
    });
    ...
    $(".addproduct-horizontal").click(function( e ) {
        ...
        quantity = $(this).closest(".product").attr("data-quantity");   // quantity?
        console.log ("added id:"+id+" Qty:"+quantity); // console debug
        $("#BSCart-Horizontal").load("ShoppingCart/addproduct_horizontal_inside.php?id="+id+"&type="+type+"&size="+size+"&quantity="+quantity);      
        e.preventDefault();
    });
    ...
    $("#BSCart").droppable({
        ...
        drop:function (event, ui) {
            ...
            $("#BSCart").load("ShoppingCart/addproduct_vertical_inside.php?action=addnew&id="+id+"&type="+type+"&size="+size+"&quantity="+quantity); 
            console.log ("added id:"+id+" Qty:"+quantity); // console debug
    ...
    $("#BSCart-Horizontal").droppable({
        ...
        drop:function (event, ui) {
            ...
            size = move.attr("data-size");   // extra size ?
            quantity = move.attr("data-quantity");   // extra size ?  
            $("#BSCart-Horizontal").load("ShoppingCart/addproduct_horizontal_inside.php?action=addnew&id="+id+"&type="+type+"&size="+size+"&quantity="+quantity); 
            console.log ("added id:"+id+" Qty:"+quantity); // console debug
        }
    });
    ...
    $(".checkout_button").click(function( e ) {
        ...
        if ( n > 1){
            window.location.href = "shoppingcart_checkout_inside.php?coupon="+$('#coupon_input').val();
        } else {
            window.location.href = "shoppingcart_checkout_inside.php";
        }
    });   
