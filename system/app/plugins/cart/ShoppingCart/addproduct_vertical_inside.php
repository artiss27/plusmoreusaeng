...
<div class="ShoppingCartHead" style="width: 165px;font-size: 10px;">
    <img  id="BSC_animation_cart" src="images/shoppingcart.png" />Shopping <font color="green">/Comprando</font>
</div>
            ...
            if (!$cart->get_cart()) {
                ...
                echo '<hr style="margin: 8px;">
                        <font style="font-size: smaller;" color="green">Vacio!<br/>';
                echo "Arrastre o Agregue Servicios</font>";
                echo "</div>";
            } else {
                ...
                echo "<div class='ShoppingCartFoot'>";
                echo "<div id='BSC_animation_count' >Total " . $total_products . " Service(s)/<font style='font-size: smaller;' color='green'>Servicio(s)</font><br/>";
                echo moneyformat($total_price);
                if (EW_SHIPPING > 0) {
                    echo " + shipping " . moneyformat(EW_SHIPPING);
                } //shipping? 
                echo "</div><br/><br/>";
                echo "<a href='/system/app/plugins/cart/shoppingcart_view_inside.php'>View shopping cart / Pay
                    <hr style='margin: 8px;''>
                    Ver carrito de compras / Pagar</a>";
                echo "</div>";
            }
            /*
            $cart = new shoppingcart();
...
<script>
  ...
  //#delete_button
    $(".delete").click(function(e) {
        ...
        $("#BSCart").load("ShoppingCart/addproduct_vertical_inside.php?action=delete&id=" + id + "&type="+type);
        e.preventDefault();
    });
</script>