    ...
    <div class="row">
        <div class="col-md-offset-2 col-md-10">
            <ul class="pagination">
				...
				echo '<li><a href="/store/'.$_SESSION['enroller'].'/'.$category.'/1/">&laquo;</a></li>'; // first page
                ...
                for ($i = 1; $i <= $total_pages; $i++) {
					...
					echo '<li '.$active.'><a href="/store/'.$_SESSION['enroller'].'/'.$category.'/'.$i.'/">'.$i.'</a></li>'; 
                    }
                    
                //echo '<li><a href="'.$_SERVER['PHP_SELF'].'?category='.$category.'&page='.$total_pages.'">&raquo;</a></li>'; // last page
				echo '<li><a href="/store/'.$_SESSION['enroller'].'/'.$category.'/'.$total_pages.'/">&raquo;</a></li>'; // first page
                ?>                
