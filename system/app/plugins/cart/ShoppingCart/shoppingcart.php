<form action="ShoppingCart/shoppingcart_update.php" method="post">
    ...
    foreach ($shoppingcart as $cart) {
        ...
        <table class="table-striped" width="100%" height="80" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td width="9%" align="center"><a href="ShoppingCart/shoppingcart_delete.php?id=<?php echo $cart['id_product']; ?>&type=<?php
                    if ($cart['id_type'] == 0) {
...
// are shipping ?? configure shipping into config.php
    ...
    if (count($row) > 0) {
        ...
        <div style="margin-top: 30px; margin-bottom: 30px; text-align: center; background-color: #f5f5f5;" class="ShoppingCartFoot" > 
            <label class="control-label">Do you have a Discount Code? Enter The Code</label>
    ...
    <div class="ShoppingCartButtons">
        <a class="btn btn-default" href="<?php echo $_SESSION['LastProductPage']; ?>">Go to services</a>                            
