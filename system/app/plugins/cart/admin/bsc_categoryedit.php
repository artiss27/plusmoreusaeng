...
$bsc_category_edit = NULL; // Initialize page object first

class cbsc_category_edit extends cbsc_category {
	...
	// Page object name
	var $PageObjName = 'bsc_category_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "")
			$this->Page_Terminate("bsc_categorylist.php"); // Invalid key, return to list
...
// Create page object
if (!isset($bsc_category_edit)) $bsc_category_edit = new cbsc_category_edit();

// Page init
$bsc_category_edit->Page_Init();

// Page main
$bsc_category_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$bsc_category_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var bsc_category_edit = new ew_Page("bsc_category_edit");
bsc_category_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = bsc_category_edit.PageID; // For backward compatibility

// Form object
var fbsc_categoryedit = new ew_Form("fbsc_categoryedit");

// Validate form
fbsc_categoryedit.Validate = function() {
...
fbsc_categoryedit.Form_CustomValidate = 
...
fbsc_categoryedit.ValidateRequired = true;
<?php } else { ?>
fbsc_categoryedit.ValidateRequired = false; 
<?php } ?>
...
<?php $bsc_category_edit->ShowPageHeader(); ?>
<?php
$bsc_category_edit->ShowMessage();
?>
<form name="fbsc_categoryedit" id="fbsc_categoryedit" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="bsc_category">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_bsc_categoryedit" class="table table-bordered table-striped">
...
<input type="hidden" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($bsc_category->id->CurrentValue) ?>">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("EditBtn") ?></button>
</form>
<script type="text/javascript">
fbsc_categoryedit.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$bsc_category_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$bsc_category_edit->Page_Terminate();
?>
