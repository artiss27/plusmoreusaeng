...
require_once "../ShoppingCart/config.php";
...
define("EW_PROJECT_NAME", "bsc_phpmaker10", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{FCDE03AD-398F-498B-9AE7-440F035B7773}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'rkTG0nqzjEjyg8kW', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/bsc_phpmaker10.css", TRUE); // Project stylesheet file name
...
// User table filters
define("EW_USER_TABLE", "`bsc_admin`",  TRUE);
