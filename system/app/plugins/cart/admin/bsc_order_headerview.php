...
<?php if ($bsc_order_header->shipping_status->Visible) { // shipping_status ?>
	<tr id="r_shipping_status"<?php echo $bsc_order_header->RowAttributes() ?>>
		<td><span id="elh_bsc_order_header_shipping_status">shipping status</span></td>
		<td<?php echo $bsc_order_header->shipping_status->CellAttributes() ?>><span id="el_bsc_order_header_shipping_status" class="control-group">
<span<?php echo $bsc_order_header->shipping_status->ViewAttributes() ?>>
<select name="ship_status" id="ship_status">
<option value="Processing" <?=$bsc_order_header->shipping_status->ViewValue == 'Processing' ? 'selected="selected"' : ''?>>Processing</option>
<option value="Shipped" <?=$bsc_order_header->shipping_status->ViewValue == 'Shipped' ? 'selected="selected"' : ''?>>Shipped</option>
</select>
</span>
</span></td>
	</tr>
...
$('#ship_status').on('change', function () {
    var selectData = $(this).val();
	var id = '<?=htmlentities($_GET['id'])?>';
    $.ajax({
        type: "POST",
        url: "bsc_order_update.php",
        data: {'selectData': selectData, 'id' : id },
