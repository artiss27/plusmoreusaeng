...
//
// Table class for bsc_orders
//
class cbsc_orders extends cTable {
	var $id;
	var $idCategory;
	var $img;
	var $name;
	...
	function __construct() {
		...
		$this->TableVar = 'bsc_orders';
		$this->TableName = 'bsc_orders';
		...
		// id
		$this->id = new cField('bsc_orders', 'bsc_orders', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// idCategory
		$this->idCategory = new cField('bsc_orders', 'bsc_orders', 'x_idCategory', 'idCategory', '`idCategory`', '`idCategory`', 3, -1, FALSE, '`idCategory`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->idCategory->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['idCategory'] = &$this->idCategory;

		// img
		$this->img = new cField('bsc_orders', 'bsc_orders', 'x_img', 'img', '`img`', '`img`', 200, -1, FALSE, '`img`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['img'] = &$this->img;

		// name
		$this->name = new cField('bsc_orders', 'bsc_orders', 'x_name', 'name', '`name`', '`name`', 200, -1, FALSE, '`name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['name'] = &$this->name;

		// description
		$this->description = new cField('bsc_orders', 'bsc_orders', 'x_description', 'description', '`description`', '`description`', 201, -1, FALSE, '`description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['description'] = &$this->description;

		// type
		$this->type = new cField('bsc_orders', 'bsc_orders', 'x_type', 'type', '`type`', '`type`', 202, -1, FALSE, '`type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['type'] = &$this->type;

		// price
		$this->price = new cField('bsc_orders', 'bsc_orders', 'x_price', 'price', '`price`', '`price`', 131, -1, FALSE, '`price`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->price->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['price'] = &$this->price;

		// price_offer
		$this->price_offer = new cField('bsc_orders', 'bsc_orders', 'x_price_offer', 'price_offer', '`price_offer`', '`price_offer`', 131, -1, FALSE, '`price_offer`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("bsc_ordersview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("bsc_ordersview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "bsc_ordersadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("bsc_ordersedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("bsc_ordersadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("bsc_ordersdelete.php", $this->UrlParm());
	}
