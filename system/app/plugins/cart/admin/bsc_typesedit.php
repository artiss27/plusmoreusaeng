...
$bsc_types_edit = NULL; // Initialize page object first

class cbsc_types_edit extends cbsc_types {
	...
	// Page object name
	var $PageObjName = 'bsc_types_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "")
			$this->Page_Terminate("bsc_typeslist.php"); // Invalid key, return to list
...
// Create page object
if (!isset($bsc_types_edit)) $bsc_types_edit = new cbsc_types_edit();

// Page init
$bsc_types_edit->Page_Init();

// Page main
$bsc_types_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$bsc_types_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var bsc_types_edit = new ew_Page("bsc_types_edit");
bsc_types_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = bsc_types_edit.PageID; // For backward compatibility

// Form object
var fbsc_typesedit = new ew_Form("fbsc_typesedit");

// Validate form
fbsc_typesedit.Validate = function() {
...
fbsc_typesedit.Form_CustomValidate = 
...
fbsc_typesedit.ValidateRequired = true;
<?php } else { ?>
fbsc_typesedit.ValidateRequired = false; 
<?php } ?>
...
<?php $bsc_types_edit->ShowPageHeader(); ?>
<?php
$bsc_types_edit->ShowMessage();
?>
<form name="fbsc_typesedit" id="fbsc_typesedit" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="bsc_types">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_bsc_typesedit" class="table table-bordered table-striped">
...
<input type="hidden" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($bsc_types->id->CurrentValue) ?>">
