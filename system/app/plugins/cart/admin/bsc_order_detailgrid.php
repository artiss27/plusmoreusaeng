...
<table id="tbl_bsc_order_detailgrid" class="table table-bordered table-hover">
...
<?php if ($bsc_order_detail->item_number->Visible) { // item_number ?>
	<?php if ($bsc_order_detail->SortUrl($bsc_order_detail->item_number) == "") { ?>
		<td><div id="elh_bsc_order_detail_item_number" class="bsc_order_detail_item_number"><div class="ewTableHeaderCaption">product code</div></div></td>
	<?php } else { ?>
		<td><div><div id="elh_bsc_order_detail_item_number" class="bsc_order_detail_item_number">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption">product code</span><span class="ewTableHeaderSort"><?php if ($bsc_order_detail->item_number->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($bsc_order_detail->item_number->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
...
<?php echo  number_format($bsc_order_detail->mc_gross->ListViewValue(), 2, '.', '') ?></span>
...
<?php echo number_format($bsc_order_detail->mc_gross->ListViewValue() / $bsc_order_detail->quantity->ListViewValue(), 2, '.', '') ?></span>
