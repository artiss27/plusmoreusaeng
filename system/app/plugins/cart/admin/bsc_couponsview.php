...
$bsc_coupons_view = NULL; // Initialize page object first

class cbsc_coupons_view extends cbsc_coupons {
	...
	// Page object name
	var $PageObjName = 'bsc_coupons_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "bsc_couponslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "bsc_couponslist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "bsc_couponslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($bsc_coupons_view)) $bsc_coupons_view = new cbsc_coupons_view();

// Page init
$bsc_coupons_view->Page_Init();

// Page main
$bsc_coupons_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$bsc_coupons_view->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var bsc_coupons_view = new ew_Page("bsc_coupons_view");
bsc_coupons_view.PageID = "view"; // Page ID
var EW_PAGE_ID = bsc_coupons_view.PageID; // For backward compatibility

// Form object
var fbsc_couponsview = new ew_Form("fbsc_couponsview");

// Form_CustomValidate event
fbsc_couponsview.Form_CustomValidate = 
...
fbsc_couponsview.ValidateRequired = true;
<?php } else { ?>
fbsc_couponsview.ValidateRequired = false; 
<?php } ?>
...
<?php $bsc_coupons_view->ExportOptions->Render("body") ?>
<?php if (!$bsc_coupons_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($bsc_coupons_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php $bsc_coupons_view->ShowPageHeader(); ?>
<?php
$bsc_coupons_view->ShowMessage();
?>
<form name="fbsc_couponsview" id="fbsc_couponsview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="bsc_coupons">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_bsc_couponsview" class="table table-bordered table-striped">
...
<?php echo $bsc_coupons->code->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $bsc_coupons->text_promotion->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<div id="orig_bsc_coupons_discount" class="hide">
<span<?php echo $bsc_coupons->discount->ViewAttributes() ?>>
<?php echo $bsc_coupons->discount->ViewValue ?></span>
</div>
...
<?php echo $bsc_coupons->visible->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
</table>
...
<script type="text/javascript">
fbsc_couponsview.Init();
</script>
<?php
$bsc_coupons_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$bsc_coupons_view->Page_Terminate();
?>
