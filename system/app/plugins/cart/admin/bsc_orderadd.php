...
$bsc_order_add = NULL; // Initialize page object first

class cbsc_order_add extends cbsc_order {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "bsc_orderview.php")
	...
	function LoadDefaultValues() {
		$this->dateorder->CurrentValue = NULL;
		$this->dateorder->OldValue = $this->dateorder->CurrentValue;
		...
		$this->payment_currency->CurrentValue = NULL;
		$this->payment_currency->OldValue = $this->payment_currency->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// dateorder
		$this->dateorder->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->dateorder->CurrentValue, 5), NULL, FALSE);
		...
		// custom
		$this->custom->SetDbValueDef($rsnew, $this->custom->CurrentValue, NULL, FALSE);
		...
		// payment_status
		$this->payment_status->SetDbValueDef($rsnew, $this->payment_status->CurrentValue, NULL, FALSE);

		// payment_amount
		$this->payment_amount->SetDbValueDef($rsnew, $this->payment_amount->CurrentValue, NULL, FALSE);

		// payment_currency
		$this->payment_currency->SetDbValueDef($rsnew, $this->payment_currency->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($bsc_order_add)) $bsc_order_add = new cbsc_order_add();

// Page init
$bsc_order_add->Page_Init();

// Page main
$bsc_order_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$bsc_order_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var bsc_order_add = new ew_Page("bsc_order_add");
bsc_order_add.PageID = "add"; // Page ID
var EW_PAGE_ID = bsc_order_add.PageID; // For backward compatibility

// Form object
var fbsc_orderadd = new ew_Form("fbsc_orderadd");

// Validate form
fbsc_orderadd.Validate = function() {
...
fbsc_orderadd.Form_CustomValidate = 
...
fbsc_orderadd.ValidateRequired = true;
<?php } else { ?>
fbsc_orderadd.ValidateRequired = false; 
<?php } ?>
...
<?php $bsc_order_add->ShowPageHeader(); ?>
<?php
$bsc_order_add->ShowMessage();
?>
<form name="fbsc_orderadd" id="fbsc_orderadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="bsc_order">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_bsc_orderadd" class="table table-bordered table-striped">
