...
//
// Table class for bsc_order
//
class cbsc_order extends cTable {
	var $id;
	var $dateorder;
	var $payer_email;
	var $payment_type;
	...
	function __construct() {
		...
		$this->TableVar = 'bsc_order';
		$this->TableName = 'bsc_order';
		...
		// id
		$this->id = new cField('bsc_order', 'bsc_order', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// dateorder
		$this->dateorder = new cField('bsc_order', 'bsc_order', 'x_dateorder', 'dateorder', '`dateorder`', 'DATE_FORMAT(`dateorder`, \'%Y/%m/%d\')', 133, 5, FALSE, '`dateorder`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->dateorder->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateYMD"));
		$this->fields['dateorder'] = &$this->dateorder;

		// payer_email
		$this->payer_email = new cField('bsc_order', 'bsc_order', 'x_payer_email', 'payer_email', '`payer_email`', '`payer_email`', 200, -1, FALSE, '`payer_email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['payer_email'] = &$this->payer_email;

		// payment_type
		$this->payment_type = new cField('bsc_order', 'bsc_order', 'x_payment_type', 'payment_type', '`payment_type`', '`payment_type`', 200, -1, FALSE, '`payment_type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['payment_type'] = &$this->payment_type;

		// custom
		$this->custom = new cField('bsc_order', 'bsc_order', 'x_custom', 'custom', '`custom`', '`custom`', 200, -1, FALSE, '`custom`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['custom'] = &$this->custom;

		// invoice
		$this->invoice = new cField('bsc_order', 'bsc_order', 'x_invoice', 'invoice', '`invoice`', '`invoice`', 200, -1, FALSE, '`invoice`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['invoice'] = &$this->invoice;

		// item_name
		$this->item_name = new cField('bsc_order', 'bsc_order', 'x_item_name', 'item_name', '`item_name`', '`item_name`', 200, -1, FALSE, '`item_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['item_name'] = &$this->item_name;

		// item_number
		$this->item_number = new cField('bsc_order', 'bsc_order', 'x_item_number', 'item_number', '`item_number`', '`item_number`', 200, -1, FALSE, '`item_number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['item_number'] = &$this->item_number;

		// quantity
		$this->quantity = new cField('bsc_order', 'bsc_order', 'x_quantity', 'quantity', '`quantity`', '`quantity`', 3, -1, FALSE, '`quantity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->quantity->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['quantity'] = &$this->quantity;

		// payment_status
		$this->payment_status = new cField('bsc_order', 'bsc_order', 'x_payment_status', 'payment_status', '`payment_status`', '`payment_status`', 200, -1, FALSE, '`payment_status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['payment_status'] = &$this->payment_status;

		// payment_amount
		$this->payment_amount = new cField('bsc_order', 'bsc_order', 'x_payment_amount', 'payment_amount', '`payment_amount`', '`payment_amount`', 200, -1, FALSE, '`payment_amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['payment_amount'] = &$this->payment_amount;

		// payment_currency
		$this->payment_currency = new cField('bsc_order', 'bsc_order', 'x_payment_currency', 'payment_currency', '`payment_currency`', '`payment_currency`', 200, -1, FALSE, '`payment_currency`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['payment_currency'] = &$this->payment_currency;

		// first_name
		$this->first_name = new cField('bsc_order', 'bsc_order', 'x_first_name', 'first_name', '`first_name`', '`first_name`', 200, -1, FALSE, '`first_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['first_name'] = &$this->first_name;

		// last_name
		$this->last_name = new cField('bsc_order', 'bsc_order', 'x_last_name', 'last_name', '`last_name`', '`last_name`', 200, -1, FALSE, '`last_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['last_name'] = &$this->last_name;

		// address_name
		$this->address_name = new cField('bsc_order', 'bsc_order', 'x_address_name', 'address_name', '`address_name`', '`address_name`', 200, -1, FALSE, '`address_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['address_name'] = &$this->address_name;

		// address_country
		$this->address_country = new cField('bsc_order', 'bsc_order', 'x_address_country', 'address_country', '`address_country`', '`address_country`', 200, -1, FALSE, '`address_country`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['address_country'] = &$this->address_country;

		// address_country_code
		$this->address_country_code = new cField('bsc_order', 'bsc_order', 'x_address_country_code', 'address_country_code', '`address_country_code`', '`address_country_code`', 200, -1, FALSE, '`address_country_code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['address_country_code'] = &$this->address_country_code;

		// address_zip
		$this->address_zip = new cField('bsc_order', 'bsc_order', 'x_address_zip', 'address_zip', '`address_zip`', '`address_zip`', 200, -1, FALSE, '`address_zip`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['address_zip'] = &$this->address_zip;

		// address_state
		$this->address_state = new cField('bsc_order', 'bsc_order', 'x_address_state', 'address_state', '`address_state`', '`address_state`', 200, -1, FALSE, '`address_state`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['address_state'] = &$this->address_state;

		// address_city
		$this->address_city = new cField('bsc_order', 'bsc_order', 'x_address_city', 'address_city', '`address_city`', '`address_city`', 200, -1, FALSE, '`address_city`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['address_city'] = &$this->address_city;

		// address_street
		$this->address_street = new cField('bsc_order', 'bsc_order', 'x_address_street', 'address_street', '`address_street`', '`address_street`', 200, -1, FALSE, '`address_street`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("bsc_orderview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("bsc_orderview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "bsc_orderadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("bsc_orderedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("bsc_orderadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("bsc_orderdelete.php", $this->UrlParm());
	}
