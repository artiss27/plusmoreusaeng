...
class cview1 extends cTable {
	...
	function __construct() {
		...
		// payer_email
		$this->payer_email = new cField('view1', 'view1', 'x_payer_email', 'payer_email', '`payer_email`', '`payer_email`', 200, -1, FALSE, '`payer_email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['payer_email'] = &$this->payer_email;

		// invoice
		$this->invoice = new cField('view1', 'view1', 'x_invoice', 'invoice', '`invoice`', '`invoice`', 200, -1, FALSE, '`invoice`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['invoice'] = &$this->invoice;

		// item_name
		$this->item_name = new cField('view1', 'view1', 'x_item_name', 'item_name', '`item_name`', '`item_name`', 200, -1, FALSE, '`item_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['item_name'] = &$this->item_name;

		// item_number
		$this->item_number = new cField('view1', 'view1', 'x_item_number', 'item_number', '`item_number`', '`item_number`', 200, -1, FALSE, '`item_number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['item_number'] = &$this->item_number;

		// quantity
		$this->quantity = new cField('view1', 'view1', 'x_quantity', 'quantity', '`quantity`', '`quantity`', 3, -1, FALSE, '`quantity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
