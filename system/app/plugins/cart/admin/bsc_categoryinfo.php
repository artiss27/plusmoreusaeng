...
//
// Table class for bsc_category
//
class cbsc_category extends cTable {
	var $id;
	var $name;
	var $description;
	var $ordering;
	...
	function __construct() {
		...
		$this->TableVar = 'bsc_category';
		$this->TableName = 'bsc_category';
		...
		// id
		$this->id = new cField('bsc_category', 'bsc_category', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// name
		$this->name = new cField('bsc_category', 'bsc_category', 'x_name', 'name', '`name`', '`name`', 200, -1, FALSE, '`name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['name'] = &$this->name;

		// description
		$this->description = new cField('bsc_category', 'bsc_category', 'x_description', 'description', '`description`', '`description`', 201, -1, FALSE, '`description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['description'] = &$this->description;

		// ordering
		$this->ordering = new cField('bsc_category', 'bsc_category', 'x_ordering', 'ordering', '`ordering`', '`ordering`', 3, -1, FALSE, '`ordering`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->ordering->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['ordering'] = &$this->ordering;

		// visible
		$this->visible = new cField('bsc_category', 'bsc_category', 'x_visible', 'visible', '`visible`', '`visible`', 3, -1, FALSE, '`visible`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("bsc_categoryview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("bsc_categoryview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "bsc_categoryadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("bsc_categoryedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("bsc_categoryadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("bsc_categorydelete.php", $this->UrlParm());
	}
