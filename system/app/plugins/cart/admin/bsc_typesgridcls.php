...
$bsc_types_grid = NULL; // Initialize page object first

class cbsc_types_grid extends cbsc_types {
	...
	// Page object name
	var $PageObjName = 'bsc_types_grid';

	// Grid form hidden field names
	var $FormName = 'fbsc_typesgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["bsc_types"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "bsc_products") {
			...
			if ($GLOBALS["bsc_products"]->EventCancelled) $this->EventCancelled = TRUE;
		}
