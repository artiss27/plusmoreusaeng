...
class cbsc_products_add extends cbsc_products {
	...
	function LoadDefaultValues() {
		...
		$this->shipping->CurrentValue = NULL;
		$this->shipping->OldValue = $this->shipping->CurrentValue;
...
<textarea data-field="x_shipping" name="x_shipping" id="x_shipping" cols="100" rows="8"<?php echo $bsc_products->shipping->EditAttributes() ?>></textarea>
