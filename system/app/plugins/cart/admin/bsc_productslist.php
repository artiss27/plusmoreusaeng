...
<img src="<?php echo $bsc_products->img_detail1->ListViewValue() ?>" alt="" style="border: 0;" width="100">
<?php } elseif (!in_array($bsc_products->CurrentAction, array("I", "edit", "gridedit"))) { ?>	
&nbsp;
<?php } ?>
<?php } else { ?>
...
<img src="<?php echo $bsc_products->img_detail2->ListViewValue() ?>" alt="" style="border: 0;" width="100">
<?php } elseif (!in_array($bsc_products->CurrentAction, array("I", "edit", "gridedit"))) { ?>	
&nbsp;
<?php } ?>
<?php } else { ?>
...
<img src="<?php echo $bsc_products->img_detail3->ListViewValue() ?>" alt="" style="border: 0;" width="100">
<?php } elseif (!in_array($bsc_products->CurrentAction, array("I", "edit", "gridedit"))) { ?>	
&nbsp;
<?php } ?>
<?php } else { ?>
