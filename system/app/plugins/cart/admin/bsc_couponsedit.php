...
$bsc_coupons_edit = NULL; // Initialize page object first

class cbsc_coupons_edit extends cbsc_coupons {
	...
	// Page object name
	var $PageObjName = 'bsc_coupons_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "")
			$this->Page_Terminate("bsc_couponslist.php"); // Invalid key, return to list
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// text_promotion
			$this->text_promotion->SetDbValueDef($rsnew, $this->text_promotion->CurrentValue, NULL, $this->text_promotion->ReadOnly);
...
// Create page object
if (!isset($bsc_coupons_edit)) $bsc_coupons_edit = new cbsc_coupons_edit();

// Page init
$bsc_coupons_edit->Page_Init();

// Page main
$bsc_coupons_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$bsc_coupons_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var bsc_coupons_edit = new ew_Page("bsc_coupons_edit");
bsc_coupons_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = bsc_coupons_edit.PageID; // For backward compatibility

// Form object
var fbsc_couponsedit = new ew_Form("fbsc_couponsedit");

// Validate form
fbsc_couponsedit.Validate = function() {
...
fbsc_couponsedit.Form_CustomValidate = 
...
fbsc_couponsedit.ValidateRequired = true;
<?php } else { ?>
fbsc_couponsedit.ValidateRequired = false; 
<?php } ?>
...
<?php $bsc_coupons_edit->ShowPageHeader(); ?>
<?php
$bsc_coupons_edit->ShowMessage();
?>
<form name="fbsc_couponsedit" id="fbsc_couponsedit" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="bsc_coupons">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_bsc_couponsedit" class="table table-bordered table-striped">
...
<input type="hidden" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($bsc_coupons->id->CurrentValue) ?>">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("EditBtn") ?></button>
</form>
<script type="text/javascript">
fbsc_couponsedit.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$bsc_coupons_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$bsc_coupons_edit->Page_Terminate();
?>
