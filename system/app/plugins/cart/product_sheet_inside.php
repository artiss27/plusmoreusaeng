                ...
                <div class="col-md-10">
                    ...
                    <div class="container"> 
                        ...
                        if (!count($row)) {
                            ...
                            ?>                
                            <div class="col-md-4">
                                <img src="assets/<?php echo $row[0]['img'] ?>"  width="270" />
                                <?php
                                // more images?                                 
                                if (isset($row[0]['img_detail1'])) {
                                    echo "<br><br>" . "<img src='assets/" . $row[0]['img_detail1'] . "'  width=\"270\"  />";
                                }
                                if (isset($row[0]['img_detail2'])) {
                                    echo "<br><br>" . "<img src='assets/" . $row[0]['img_detail2'] . "'  width=\"270\"  />";
                                }
                                if (isset($row[0]['img_detail3'])) {
                                    echo "<br><br>" . "<img src='assets/" . $row[0]['img_detail3'] . "'  width=\"270\"  />";
                                }
                                ?>
                            ...
                            if (count($types)) {
                                ...
                                <a class="btn btn-default" href="/system/app/plugins/cart/shoppingcart_view_inside.php" style="margin: 5px;">View shopping cart<font color="green">/Ver la carrito de compra</font></a>
                                <?php
                                ...
                                if (isset($next[0]['id']) > 0) {
                                    // echo '<a class="btn btn-default" href="product_sheet.php?id=' . $next[0]['id'] . '"><i class="icon-chevron-left"></i>Previous product</a> ';
									 echo '<a class="btn btn-default" href="/store/cart/info/' . $next[0]['id'] . '/"><i class="icon-chevron-left"></i>Previous product</a> ';
                                }
                                if (isset($prev[0]['id']) > 0) {
									...
									echo '<a class="btn btn-default" href="/store/cart/info/' . $prev[0]['id'] . '/">Next product<i class="icon-chevron-right"></i></a>';
                                }
                                ?>
                                </p>
                            </div>
