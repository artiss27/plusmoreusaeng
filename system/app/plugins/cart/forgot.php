   ...
   require_once "ShoppingCart/_ShoppingCart.php";     // load class ShoppingCart
	...
	if(isset($_POST['type'])) {
		if ($_POST['type'] == "forgot") {
			trackRetries('forgot');
			if(SendResetEmail($_POST['email'])){
				$_SESSION['alert']['type'] = "success";
				$_SESSION['alert']['message'] = "Reset password link was sent to your email.";	
			}
		}
	}
            ...
            <body>
                         ...
                         <br><br>
                           ...
                           <div class="col-md-4">
                              <table class="ShoppingCartHead" width="100%" height="40" border="0" cellspacing="0" cellpadding="0" >
                                 <tr>
                                    <td align="left">&nbsp;&nbsp;Forgot Password</td>
                                 </tr>
                              </table>
                              ...
                              <div style="margin-top: 20px;">
                                 <form action="" method="post" id="forgot_form" name="forgot_form">
                                    <div class="row">
                                       <div class="col-md-12">
               ...
               <script>
                  $(document).ready(function () {
					  ...
					  $("#forgot_form").validationEngine(); // init form validator
                  });
               </script>
            </body>
         </html>