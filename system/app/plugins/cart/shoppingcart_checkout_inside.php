            ...
            <div class="row">
                ...
                <div class="col-sm-2 col-md-2 hidden-sm hidden-xs">
                    <div class="nav-list" id="cartbox">  
                        ...
                        <a class="btn btn-success" onclick="$('#paypalform').attr('action', 'ShoppingCart/dopayment.php');document.paypalform.submit();">Pay<i class="icon-chevron-right"></i></a>
                    ...
                    <div class="container"> 
                        <div class="col-sm-10 col-md-10">
                            ...
                            if (!$cart->get_cart()) {  //checking if the cart is empty or not
                                ...
                                include("ShoppingCart/checkout_inside.php"); //show shoppingcart
