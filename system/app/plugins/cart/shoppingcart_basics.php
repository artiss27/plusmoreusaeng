...
include "ShoppingCart/products_grid.php";  // list products</pre>
                        <br />
...
?&gt;</pre><br />
                            ...
                            <pre>&lt;link rel="stylesheet" href="ShoppingCart/ShoppingCart.css"&gt;
&lt;link rel="stylesheet" href="ShoppingCart/animation.css"&gt;</pre><br />
                            <h4>Install: Load JQUERY Shopping Cart</h4>
                            <pre>&lt;script&gt;
$(document).ready(function() {                
	$("#BSCart-Horizontal").load("ShoppingCart/addproduct_horizontal.php");
});            
&lt;/script&gt;</pre><br />
