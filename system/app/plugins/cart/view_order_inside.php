                  ...
                  <div class="row">
                     ...
                     <div class="col-md-12">
                        ...
                        <div class="container">
                           ...
                           <?php endif; ?><br><br>
                           <div class="col-md-12">
                           <h4>Order Detail For Invoice <?=htmlentities($_GET['invoice'])?></h4>
                           <br>
                              <div class="table-responsive">
                                 <table summary="Product Purchases" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
										...
										$orders = GetOrderDetail($_GET['invoice']);
										if(!$orders):
											echo '<tr><td colspan="6">No purchases found for for the requested invoice.</td></tr>';	
										else:
                                        ...
                                        <td>
                                        <?=GetProductImage($order['item_number'])?>
                                        </td> 
                                        <td>
                                        <?=$order['quantity']?>
                                        </td> 
                                        <td>
                                        <?=EW_CURRENCY_SYMBOL . $order['mc_gross']?>
                                        </td> 
                                        </tr>
                                        <?php endforeach;
										endif;
