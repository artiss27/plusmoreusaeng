											...
											<div class="columns clear bt-space15">
												<div class="col2-3">
													<div class="clear">
														...
														<input name="min_textad_bid" type="text" id="textfield" placeholder="0.005" size="5" value='{$settings.min_textad_bid}' class="form-control" />
													</div>
													<div class="clear">
														<label for="textfield" class="form-label size-120 fl-space2">Max countries per textad campaigns:</label>
													
														<input name="max_textad_countries" type="text" id="textfield" placeholder="10" size="5" value='{$settings.max_textad_countries}' class="form-control" />
													</div>
