   ...
   <div class="normalheader transition animated fadeIn">
      <div class="hpanel">
         <div class="panel-body">
            ...
            <small>{$lang.internal_message_system}</small>
         </div>
      </div>
   </div>
   <div class="row">
                                          ...
                                          <div class="panel-body">
                                             <ul class="mailbox-list">
                                                ...
                                                <li {if $smarty.request.p == 'send'}class="active"{/if}>
                                                   <a href="messages/&p=send"><i class="fa fa-paper-plane"></i> {$lang.sent_messages}</a>
                                                </li>
                                                <li {if $smarty.request.p == 'read'}class="active"{/if}>
                                                   <a href="messages/&p=read"><i class="fa fa-paper-plane"></i> {$lang.read_messages}</a>
                                                </li>
                                                <li {if $smarty.request.p == 'deleted'}class="active"{/if}>
                                                   <a href="messages/&p=deleted"><i class="fa fa-trash"></i> {$lang.deleted_messages}</a>
                                                </li>
                                            <!-- </ul>
                                             <ul class="mailbox-list">
                                                <li>
                                          ...
                                          <div class="panel-body">
                                             <div class="row">
                                                ...
                                                <form id="new" name="new" method="post" action="">
                                                   <p><strong><a href="#" onClick="toggle_visibility('send');"><H5>NEW EMAIL</H5></a></strong></p>
                                                   <div id="send" {if !$smarty.post.reply && $smarty.request.sponsor != 1 && $smarty.request.admin != 1}style='display:none;'{/if}>
...
<option value="admin" {if $smarty.request.admin == '1'}selected="selected"{/if}>PlusMoreUsa </option> 
                                                  <option value="all">{$lang.all_my_direct_referrals}</option>
                                                               <option value="free">{$lang.all_my_free_direct_referrals}</option>
                                                               <option value="paid">{$lang.all_my_paid_direct_referrals}</option>
                                                               <option value="sponsor" {if $smarty.request.sponsor == '1'}selected="selected"{/if}>{$lang.my_sponsor}</option>            
                                                               {foreach from=$directs_data item=row}
                                                               <option value="{$row.member_id}">{$row.username}</option>
                                                               {/foreach}
                                                            </select>
                                                            {/if}
                                                         </td>
                                             ...
                                             <table id="msg" class="table table-striped table-bordered table-hover">
                                                ...
                                                <tr>
                                                   <td>{$message.from}</td>
                                                   <td><a href='messages/&p=view&mid={$message.id}'>
                                             ...
                                             <table id="msg" class="table table-striped table-bordered table-hover">
                                                ...
                                                <tr>
                                                   <td>{$message.to}</td>
                                                   <td><a href='messages/&p=view&mid={$message.id}'>{$message.title}</a></td>
                                                   <td>
