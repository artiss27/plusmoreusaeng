                                          ...
                                          <tr>                                             
                                              <td>
                                                <table class="table">
                                                   ...
                                                   <tr>
                                                      <td>Category / <font size="2" color="green">Categoria</td>
                                                      <td>{$name.category}</td>
                                                   </tr>
                                                   <tr>
                                             ...
                                             <td><a href="#myModal{$name.id}" data-toggle="modal" data-target="#myModal{$name.id}">edit</a> | <a href="/admin/downloads/&del={$name.id}" onClick="return confirm ('Do you really want to delete this download?');">delete</a></td>
                                          </tr>
