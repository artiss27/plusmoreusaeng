               ...
               {/if} 
                        <form action="" method="post">
                            <div class="form-group"><center><font size="5" color="#6a6c6f"><u>Entrada BackOffice Virtual</u></font><br><font size="3" color="#6a6c6f">Virtual BackOffice Entrance</font></center><br><br>
                                ...
                                <input type="text" title="Por Favor Entrar Usuario/Please enter you username" required value="{if $smarty.const.DEMO == 1}demo{/if}" name="username" id="user" class="form-control">                                
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="password"><font size="3">Contrase&ntilde;a*</font><br>Password*</label>
                                <input type="password" title="Favor entrar contrase&ntilde;a correcta / Please enter your password" required value="{if $smarty.const.DEMO == 1}demo{/if}" name="password" id="password" class="form-control">                              
                            </div>
						...
						{if $smarty.const.DEMO == 1}<br><br>Demo is reseted every 20 minutes{/if}
                </div>
            </div>
        </div>
    </div>
