										...
										<form action="" method="post" class="validate-form form bt-space15">
											<div class="columns clear bt-space15">
												<div class="col2-3">
													...
													Select how much Ad Credits will get the member on start up.<br />
													<table width="100%" cellspacing="0" class="basic">
														<tbody>
															...
															<tr>
																...
																<td>
																	{capture assign=comm}{$name}_adcredit_startup{/capture}             
																	<label for="textfield"></label>
																	<input name="{$name}_adcredit_startup" type="text" id="textfield" size="6" class="form-control" value="{$settings.$comm}" />
																</td>
															</tr>
															{/foreach}                            
														</tbody>
